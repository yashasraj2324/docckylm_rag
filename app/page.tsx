    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-8 py-4 border-b border-gray-200">
        ...
        <nav className="flex items-center gap-8">
          <a href="#" className="text-gray-900 border-b-2 border-gray-900 pb-1">
            Overview
          </a>
          ...
          <div className="flex items-center gap-4">
            {/* GitHub Icon */}
            <button className="w-8 h-8 flex items-center justify-center text-gray-800 hover:text-gray-500 transition-colors">
      ...
      <main className="flex flex-col items-center justify-center px-8 pt-24 pb-16">
        <h1 className="text-8xl mb-8 text-center">
          <span className="text-gray-900">Understand </span>
        ...
        <button
          ...
          className="bg-gray-900 text-white px-12 py-4 rounded-full text-lg hover:bg-gray-800 transition-colors"
        >
          Try DOOCYLM
        </button>
      </main>
